...
public enum WsGoal {
    ...
    COMMIT("commit", CommitMojo.class,
            "Commit uncommitted changes across components."),
    ...
    FEATURE_ABANDON_DRAFT("feature-abandon-draft", FeatureAbandonDraftMojo.class,
            "Preview abandoning a feature branch across components."),
    FEATURE_ABANDON_PUBLISH("feature-abandon-publish", FeatureAbandonPublishMojo.class,
            "Abandon a feature branch across components."),
    ...
    FEATURE_START_DRAFT("feature-start-draft", FeatureStartDraftMojo.class,
            "Preview starting a feature branch across components."),
    ...
    INIT("init", InitWorkspaceMojo.class,
            "Initialize a workspace: clone components per workspace.yaml."),
    ...
    SET_PARENT_DRAFT("set-parent-draft", WsSetParentDraftMojo.class,
            "Preview a parent-POM version bump across components."),
    SET_PARENT_PUBLISH("set-parent-publish", WsSetParentPublishMojo.class,
            "Apply a parent-POM version bump across components."),
    ...
    SWITCH_DRAFT("switch-draft", WsSwitchDraftMojo.class,
            "Preview switching components to a coordinated branch."),
    SWITCH_PUBLISH("switch-publish", WsSwitchPublishMojo.class,
            "Switch components to a coordinated branch."),
    SYNC("sync", WsSyncMojo.class,
            "Sync workspace.yaml to match on-disk component state."),
    ...
    UPGRADE_DRAFT("upgrade-draft", WsUpgradeDraftMojo.class,
            "Preview workspace convention upgrades."),
    UPGRADE_PUBLISH("upgrade-publish", WsUpgradePublishMojo.class,
            "Apply workspace convention upgrades."),
    ...
    VERIFY_CONVERGENCE("verify-convergence", VerifyConvergenceMojo.class,
            "Verify transitive dependency convergence across components.");
