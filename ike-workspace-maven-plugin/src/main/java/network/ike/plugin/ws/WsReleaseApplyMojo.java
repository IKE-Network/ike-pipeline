 ...
 *
 * <p>This is the {@code -apply} counterpart of {@code ws:release}
 * (which defaults to a dry-run preview). Before releasing, this goal
 ...
 * @see WsReleaseMojo
 */
@Mojo(name = "release-apply", requiresProject = false, threadSafe = true)
public class WsReleaseApplyMojo extends WsReleaseMojo {
