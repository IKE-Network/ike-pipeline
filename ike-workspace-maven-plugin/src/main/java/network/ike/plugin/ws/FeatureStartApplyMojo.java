 ...
 *
 * <p>This is the {@code -apply} counterpart of {@code ws:feature-start}
 * (which defaults to a dry-run preview). Before creating feature branches,
 ...
 */
@Mojo(name = "feature-start-apply", requiresProject = false, threadSafe = true)
public class FeatureStartApplyMojo extends FeatureStartMojo {
