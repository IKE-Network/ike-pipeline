...
#   PDF:      Prawn inline formatting via <color> and <b> tags
...
class KonceptInlineMacro < Asciidoctor::Extensions::InlineMacroProcessor
  use_dsl
  ...
  def render_pdf(parent, target, url, uuid)
    ...
    # Small-caps not supported in Prawn, so we use ALL-CAPS as fallback.
...
Asciidoctor::Extensions.register do
  inline_macro KonceptInlineMacro
end
