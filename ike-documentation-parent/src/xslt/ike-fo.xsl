...
<!--
  ...
  This file is consumed by the pdf-xep Maven profile, which resolves the
  import URI via an XML catalog that maps the canonical DocBook XSL URI
  to the locally unpacked stylesheets.
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!--                                                                 -->
  <!-- At build time, this file is copied to:                          -->
  <!--   target/docbook-xsl-ns/custom/ike-fo.xsl                      -->
  <!--                                                                 -->
  <!-- The unpacked DocBook XSL-NS stylesheets live at:                -->
  <!--   target/docbook-xsl-ns/fo/docbook.xsl                         -->
  <!--                                                                 -->
